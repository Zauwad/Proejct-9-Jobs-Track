            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    ...
                    <div className="card-body space-y-5">
                        ...
                        <p>New to this website? please <NavLink className='text-blue-500' to='/signup'>Sign Up</NavLink></p>



                        <button onClick={handleGoogleLogIn} className='btn btn-ghost bg-orange-500 shadow-lg shadow-orange-500/50 ...'>
                            <FaGoogle />
